...
export const knowledgeBaseLookup = {
  name: "knowledge_base_lookup",
  description: "Searches the knowledge base for relevant information. Results are company-specific.",
  schema: {
    type: "object",
    properties: {
      query: {
  ...
  execute: async function(args: any, context: ToolContext) {
