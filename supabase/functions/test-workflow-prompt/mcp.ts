...
// Enhanced tool definitions for MCP
export const getEnhancedTools = (): MCPTool[] => [
  {
    name: 'detect_action',
  ...
  },
  {
    ...
    description: 'Generates a specific action based on the project context and decision from detect_action',
    parameters: {
      type: 'object',
      properties: {
        action_type: {
  ...
  },
  {
    ...
    description: 'Queries the knowledge base for relevant information when additional context is needed',
    parameters: {
      type: 'object',
      properties: {
        query: {
...
// Core MCP tool definitions for our workflow (maintain backward compatibility)
